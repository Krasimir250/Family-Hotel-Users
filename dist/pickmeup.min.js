...
(function (F, x) {
  ...
  function y(a, b, c, d) {
    ...
    if (c && -1 !== c.indexOf(" "))
      ...
      for (e = a.__pickmeup.events, g = e.length, f = 0; f < g; ++f)
        (b && b != e[f][0]) ||
          (c && c != e[f][1]) ||
          (d && d != e[f][2]) ||
          e[f][0].removeEventListener(e[f][1], e[f][2]);
  }
  ...
  function N(a) {
    ...
    x(
      Array.prototype.slice.call(
        b.querySelectorAll(".pmu-instance \x3e :not(nav)")
      )
    );
    for (var h = 0; h < c.calendars; h++) {
      ...
      n(b, "pmu-view-years")
        ? (w(k, 12 * (h - d)),
          (m = k.getFullYear() - 6 + " - " + (k.getFullYear() + 5)))
        : n(b, "pmu-view-months")
        ? (w(k, h - d), (m = k.getFullYear()))
        : n(b, "pmu-view-days") &&
          (q(k, h - d), (m = D(k, c.title_format, c.locales[c.locale])));
      if (
        !r &&
        l &&
        ((r = new Date(k)),
      ...
      if (
        !v &&
        ((v = new Date(k)), v.setDate(1), q(v, 1), z(v, -1), f && f > v)
      ) {
        --h;
        q(G, 1);
        v = void 0;
            ...
            ("multiple" == c.mode &&
              -1 !==
                e
                  ...
                  .indexOf(a + "-" + b)) ||
            (new Date(e).getFullYear() == a && new Date(e).getMonth() == b)
          );
        };
      (function () {
        var a = [],
      ...
      (function () {
        ...
        for (l = 0; 12 > l; ++l)
          (m = document.createElement("div")),
            (m.textContent = c.locales[c.locale].monthsShort[l]),
            (m.__pickmeup_month = l),
            (m.__pickmeup_year = b),
            (c.min && (b < d || (l < e && b == d))) ||
            (c.max && (b > f || (l > h && b >= f)))
              ? g(m, "pmu-disabled")
              : u(b, l) && g(m, "pmu-selected"),
            a.push(m);
      ...
      (function () {
        ...
        for (e = 0; 42 > e; ++e)
          (f = document.createElement("div")),
            (f.textContent = k.getDate()),
            (f.__pickmeup_day = k.getDate()),
            (f.__pickmeup_month = k.getMonth()),
            (f.__pickmeup_year = k.getFullYear()),
            b != k.getMonth() && g(f, "pmu-not-in-month"),
            0 == k.getDay()
              ? g(f, "pmu-sunday")
              : 6 == k.getDay() && g(f, "pmu-saturday"),
            (h = c.render(new Date(k)) || {}),
            (l = k.valueOf()),
            (m = (c.min && c.min > k) || (c.max && c.max < k)),
            (selected =
              c.date.valueOf() == l ||
              (c.date instanceof Array &&
                c.date.reduce(function (a, b) {
                  return a || l === b.valueOf();
                }, !1)) ||
              ("range" == c.mode && l >= c.date[0] && l <= c.date[1])),
            h.disabled || (!("disabled" in h) && m)
              ? g(f, "pmu-disabled")
              : (h.selected || (!("selected" in h) && selected)) &&
                g(f, "pmu-selected"),
            l == d && g(f, "pmu-today"),
            h.class_name && h.class_name.split(" ").forEach(g.bind(f, f)),
            a.push(f),
            z(k, 1);
  ...
  function u(a, b) {
    ...
    a = a.split(d);
    for (
      var d = c.split(d), g, f, l, k, m, p = new Date(), c = 0;
      c < a.length;
      c++
    )
      switch (d[c]) {
        ...
        case "p":
          /pm/i.test(a[c]) && 12 > k
            ? (k += 12)
            : /am/i.test(a[c]) && 12 <= k && (k -= 12);
          break;
        case "M":
          m = parseInt(a[c], 10);
      }
    e = new Date(
      void 0 === l ? p.getFullYear() : l,
      void 0 === f ? p.getMonth() : f,
      void 0 === g ? p.getDate() : g,
      void 0 === k ? p.getHours() : k,
      void 0 === m ? p.getMinutes() : m,
      0
    );
  ...
  function O(a, b) {
    ...
    B(a, "input") &&
      (a.value =
        "single" == c.mode
          ? b.formatted_date
          : b.formatted_date.join(c.separator));
    C(a, "change", b);
    c.flat ||
      !c.hide_on_select ||
      ("range" == c.mode && c.lastSel) ||
      c.bound.hide();
  }
  ...
  function P(a, b) {
    ...
    d = Array.prototype.slice
      .call(b.querySelectorAll(".pmu-instance"))
      .indexOf(d);
    B(c.parentElement, "nav")
      ? n(c, "pmu-month")
        ? (q(a.current, d - Math.floor(a.calendars / 2)),
          n(b, "pmu-view-years")
            ? ((a.current =
                "single" != a.mode
                  ...
                  : new Date(a.date)),
              a.select_day
                ? (b.classList.remove("pmu-view-years"), g(b, "pmu-view-days"))
                : a.select_month &&
                  (b.classList.remove("pmu-view-years"),
                  g(b, "pmu-view-months")))
            : n(b, "pmu-view-months")
            ? a.select_year
              ? (b.classList.remove("pmu-view-months"), g(b, "pmu-view-years"))
              : a.select_day &&
                (b.classList.remove("pmu-view-months"), g(b, "pmu-view-days"))
            : n(b, "pmu-view-days") &&
              (a.select_month
                ? (b.classList.remove("pmu-view-days"), g(b, "pmu-view-months"))
                : a.select_year &&
                  (b.classList.remove("pmu-view-days"),
                  g(b, "pmu-view-years"))))
        : n(c, "pmu-prev")
        ? a.bound.prev(!1)
        : a.bound.next(!1)
      : n(b, "pmu-view-years")
      ? (a.current.setFullYear(c.__pickmeup_year),
        a.select_month
          ? (b.classList.remove("pmu-view-years"), g(b, "pmu-view-months"))
          : a.select_day
          ? (b.classList.remove("pmu-view-years"), g(b, "pmu-view-days"))
          : a.bound.update_date(a.current))
      : n(b, "pmu-view-months")
      ? (a.current.setMonth(c.__pickmeup_month),
        a.current.setFullYear(c.__pickmeup_year),
        a.select_day
          ? (b.classList.remove("pmu-view-months"), g(b, "pmu-view-days"))
          : a.bound.update_date(a.current),
        q(a.current, Math.floor(a.calendars / 2) - d))
      : ((b = new Date(a.current)),
        b.setYear(c.__pickmeup_year),
        b.setMonth(c.__pickmeup_month),
        b.setDate(c.__pickmeup_day),
        a.bound.update_date(b));
    a.bound.fill();
    return !0;
  }
  ...
  function Q(a, b) {
    ...
    (b &&
      b.target &&
      (b.target == a || c.compareDocumentPosition(b.target) & 16)) ||
      !C(a, "hide") ||
      (g(c, "pmu-hidden"),
      y(a, document.documentElement, "click", d.bound.hide),
      y(a, window, "resize", d.bound.forced_show),
      (d.lastSel = !1));
  }
  ...
  function T(a, b) {
    ...
    n(c, "pmu-view-years")
      ...
      : n(c, "pmu-view-months")
      ? w(a.current, -1)
      : n(c, "pmu-view-days") && q(a.current, -1);
    b && a.bound.fill();
  }
  ...
  function W(a, b, c) {
      ...
      if (((d.date = u(b, d)), "single" != d.mode))
        for (
          d.date instanceof Array
            ? ((d.date[0] = d.date[0] || u(new Date(), d)),
              "range" == d.mode && (d.date[1] = d.date[1] || u(d.date[0], d)))
            : ((d.date = [d.date]),
              "range" == d.mode && d.date.push(u(d.date[0], d))),
            b = 0;
          b < d.date.length;
          ++b
        )
          d.date[b] = L(d.date[b], d.min, d.max);
      else
    ...
    if ("multiple" == d.mode)
      for (b = 0; b < d.date.length; ++b)
        d.date.indexOf(d.date[b]) !== b && (d.date.splice(b, 1), --b);
    c
      ? (d.current = u(c, d))
      : ((c = "single" === d.mode ? d.date : d.date[d.date.length - 1]),
        (d.current = c ? new Date(c) : new Date()));
    d.current.setDate(1);
    d.bound.fill();
    B(a, "input") &&
      !1 !== d.default_date &&
      ...
      (d =
        "single" == d.mode
          ? c.formatted_date
          : c.formatted_date.join(d.separator)),
      b || C(a, "change", c),
      b != d && (a.value = d));
  }
  ...
  function E(a, b) {
    ...
    if (!a.__pickmeup) {
      ...
      for (c in d)
        (b = a.getAttribute("data-pmu-" + c)), null !== b && (d[c] = b);
      ...
      d.flat
        ? (g(b, "pmu-flat"), a.appendChild(b))
        : (g(b, "pmu-hidden"),
          document.body.appendChild(b),
          t(a, a, "click", I.bind(a, a, !1)),
          t(a, a, "input", d.bound.update),
          t(a, a, "change", d.bound.update));
  ...
  E.defaults = {
    ...
    locales: {
      en: {
        days: "Неделя Понеделник Вторник Сряда Четвъртък Петък Събота".split(
          " "
        ),
        daysShort: "Нд Пон Вт Ср Чт Пт Сб".split(" "),
        daysMin: "Нд Пон Вт Ср Чт Пт Сб".split(" "),
        months:
          "Януари Февруари Март Април Май Юни Юли Август Септември Октомври Ноевмври Декември".split(
            " "
          ),
        monthsShort: "Ян Фев Мар Апр Май Юн Юл Авг Сеп Окт Ное Дек".split(" "),
      },
    },
    instance_template: function (a) {
      ...
      return (
        '\x3cdiv class\x3d"pmu-instance"\x3e\x3cnav\x3e\x3cdiv class\x3d"pmu-prev pmu-button"\x3e' +
        a.prev +
        '\x3c/div\x3e\x3cdiv class\x3d"pmu-month pmu-button"\x3e\x3c/div\x3e\x3cdiv class\x3d"pmu-next pmu-button"\x3e' +
        a.next +
        '\x3c/div\x3e\x3c/nav\x3e\x3cnav class\x3d"pmu-day-of-week"\x3e\x3cdiv\x3e' +
        b.join("\x3c/div\x3e\x3cdiv\x3e") +
        "\x3c/div\x3e\x3c/nav\x3e\x3c/div\x3e"
      );
    },
